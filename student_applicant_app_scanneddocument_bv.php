...
// Create page object
$student_applicant_app_scanneddocument_blobview = new cstudent_applicant_app_scanneddocument_blobview();
$Page =& $student_applicant_app_scanneddocument_blobview;

// Page init
$student_applicant_app_scanneddocument_blobview->Page_Init();

// Page main
$student_applicant_app_scanneddocument_blobview->Page_Main();
?>
<?php
$student_applicant_app_scanneddocument_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cstudent_applicant_app_scanneddocument_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'student_applicant_app_scanneddocument_blobview';
	...
	//
	function cstudent_applicant_app_scanneddocument_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('student_applicant', 'x_app_scanneddocument');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('app_scanneddocument');
