...
// Create page object
$Liquidate_Payment_Request_liquidationdoc_blobview = new cLiquidate_Payment_Request_liquidationdoc_blobview();
$Page =& $Liquidate_Payment_Request_liquidationdoc_blobview;

// Page init
$Liquidate_Payment_Request_liquidationdoc_blobview->Page_Init();

// Page main
$Liquidate_Payment_Request_liquidationdoc_blobview->Page_Main();
?>
<?php
$Liquidate_Payment_Request_liquidationdoc_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cLiquidate_Payment_Request_liquidationdoc_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'Liquidate_Payment_Request_liquidationdoc_blobview';
	...
	//
	function cLiquidate_Payment_Request_liquidationdoc_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('Liquidate Payment Request');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('Liquidate_Payment_Request', 'x_liquidationdoc');
		...
		// SQL constructor in Liquidate_Payment_Request class, Liquidate_Payment_Requestinfo.php
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('liquidationdoc');
