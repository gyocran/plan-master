...
<?php echo $users->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		<td valign="top"><?php echo $users->zuserid->FldCaption() ?></td>
		<td valign="top"><?php echo $users->username->FldCaption() ?></td>
		<td valign="top"><?php echo $users->password->FldCaption() ?></td>
		<td valign="top"><?php echo $users->userlevelid->FldCaption() ?></td>
		<td valign="top"><?php echo $users->groupid->FldCaption() ?></td>
		<td valign="top"><?php echo $users->parentid->FldCaption() ?></td>
		<td valign="top"><?php echo $users->programarea_programarea_id->FldCaption() ?></td>
	</tr>
	</thead>
	<tbody>
<?php
...
<div<?php echo $users->zuserid->ViewAttributes() ?>><?php echo $users->zuserid->ListViewValue() ?></div></td>
...
<div<?php echo $users->userlevelid->ViewAttributes() ?>><?php echo $users->userlevelid->ListViewValue() ?></div></td>
		<td<?php echo $users->groupid->CellAttributes() ?>>
<div<?php echo $users->groupid->ViewAttributes() ?>><?php echo $users->groupid->ListViewValue() ?></div></td>
		<td<?php echo $users->parentid->CellAttributes() ?>>
<div<?php echo $users->parentid->ViewAttributes() ?>><?php echo $users->parentid->ListViewValue() ?></div></td>
		<td<?php echo $users->programarea_programarea_id->CellAttributes() ?>>
<div<?php echo $users->programarea_programarea_id->ViewAttributes() ?>><?php echo $users->programarea_programarea_id->ListViewValue() ?></div></td>
	</tr>
<?php
	$rs->MoveNext();
}
...
class cusers_delete {
	...
	function Page_Main() {
		...
		if (@$_GET["zuserid"] <> "") {
			...
			if (!is_numeric($users->zuserid->QueryStringValue))
				$this->Page_Terminate("userslist.php"); // Prevent SQL injection, exit
			$sKey .= $users->zuserid->QueryStringValue;
		} else {
			$bSingleDelete = FALSE;
		}
		if ($bSingleDelete) {
