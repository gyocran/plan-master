...
$RootMenu->AddMenuItem(31, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("31", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "Refund_Report_detailedsmry.php", -1, "", "", TRUE);
$RootMenu->AddMenuItem(32, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("32", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "Refunds_summariessmry.php", -1, "", "", TRUE);
$RootMenu->AddMenuItem(33, $ReportLanguage->Phrase("DetailSummaryReportMenuItemPrefix") . $ReportLanguage->MenuPhrase("33", "MenuText") . $ReportLanguage->Phrase("DetailSummaryReportMenuItemSuffix"), "Payments_wBankDetailssmry.php", -1, "", "", TRUE);
$RootMenu->Render();
?>
</div>
<!-- End Main Menu -->
