...
define("EWRPT_PROJECT_NAME", "PlanGhReports", TRUE); // Project Name
define("EWRPT_PROJECT_VAR", "PlanGhReports", TRUE); // Project Var
...
define("EWRPT_CONN_DB", 'plangh_user2', TRUE);
...
define("EWRPT_RANDOM_KEY", 'B6Vj1YWAOOVk5NTe', TRUE); // Random key for encryption
define("EWRPT_PROJECT_STYLESHEET_FILENAME", "phprptcss/PlanGhReports.css", TRUE); // Project stylesheet file name
