...
class cPayment_Refund {
	...
	function cPayment_Refund() {
		...
		$this->scholarship_payment_id = new cField('Payment_Refund', 'Payment Refund', 'x_scholarship_payment_id', 'scholarship_payment_id', 'scholarship_payment.scholarship_payment_id', 3, -1, FALSE, 'scholarship_payment.scholarship_payment_id', FALSE);
		...
		// date
		$this->date = new cField('Payment_Refund', 'Payment Refund', 'x_date', 'date', 'scholarship_payment.date', 135, 7, FALSE, 'scholarship_payment.date', FALSE);
		$this->date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['date'] =& $this->date;

		// status
		$this->status = new cField('Payment_Refund', 'Payment Refund', 'x_status', 'status', 'scholarship_payment.status', 202, -1, FALSE, 'scholarship_payment.status', FALSE);
		$this->fields['status'] =& $this->status;

		// refund_amount
		$this->refund_amount = new cField('Payment_Refund', 'Payment Refund', 'x_refund_amount', 'refund_amount', 'scholarship_payment.refund_amount', 131, -1, FALSE, 'scholarship_payment.refund_amount', FALSE);
		$this->refund_amount->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['refund_amount'] =& $this->refund_amount;

		// amount
		$this->amount = new cField('Payment_Refund', 'Payment Refund', 'x_amount', 'amount', 'scholarship_payment.amount', 131, -1, FALSE, 'scholarship_payment.amount', FALSE);
		$this->amount->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['amount'] =& $this->amount;

		// memo
		$this->memo = new cField('Payment_Refund', 'Payment Refund', 'x_memo', 'memo', 'scholarship_payment.memo', 201, -1, FALSE, 'scholarship_payment.memo', FALSE);
		$this->fields['memo'] =& $this->memo;

		// year
		$this->year = new cField('Payment_Refund', 'Payment Refund', 'x_year', 'year', 'scholarship_payment.year', 3, -1, FALSE, 'scholarship_payment.year', FALSE);
		...
		$this->programarea_residentarea_id = new cField('Payment_Refund', 'Payment Refund', 'x_programarea_residentarea_id', 'programarea_residentarea_id', 'scholarship_payment.programarea_residentarea_id', 3, -1, FALSE, 'scholarship_payment.programarea_residentarea_id', FALSE);
		...
		$this->programarea_payingarea_id = new cField('Payment_Refund', 'Payment Refund', 'x_programarea_payingarea_id', 'programarea_payingarea_id', 'scholarship_payment.programarea_payingarea_id', 3, -1, FALSE, 'scholarship_payment.programarea_payingarea_id', FALSE);
		...
		$this->payment_request_payment_request_id = new cField('Payment_Refund', 'Payment Refund', 'x_payment_request_payment_request_id', 'payment_request_payment_request_id', 'scholarship_payment.payment_request_payment_request_id', 3, -1, FALSE, 'scholarship_payment.payment_request_payment_request_id', FALSE);
		...
		// bankname
		$this->bankname = new cField('Payment_Refund', 'Payment Refund', 'x_bankname', 'bankname', 'scholarship_payment.bankname', 200, -1, FALSE, 'scholarship_payment.bankname', FALSE);
		$this->fields['bankname'] =& $this->bankname;

		// account_no
		$this->account_no = new cField('Payment_Refund', 'Payment Refund', 'x_account_no', 'account_no', 'scholarship_payment.account_no', 200, -1, FALSE, 'scholarship_payment.account_no', FALSE);
		$this->fields['account_no'] =& $this->account_no;

		// schools_school_id
		$this->schools_school_id = new cField('Payment_Refund', 'Payment Refund', 'x_schools_school_id', 'schools_school_id', 'scholarship_payment.schools_school_id', 3, -1, FALSE, 'scholarship_payment.schools_school_id', FALSE);
		...
		// group_id
		$this->group_id = new cField('Payment_Refund', 'Payment Refund', 'x_group_id', 'group_id', 'scholarship_payment.group_id', 3, -1, FALSE, 'scholarship_payment.group_id', FALSE);
	...
	// Master filter
	function SqlMasterFilter_view_for_payment_refund_selection() {
		return "scholarship_payment.scholarship_payment_id=@scholarship_payment_id@";
	}

	// Detail filter
	function SqlDetailFilter_view_for_payment_refund_selection() {
		return "scholarship_payment.scholarship_payment_id=@scholarship_payment_id@";
	}
	...
	function SqlSelect() { // Select
		return "SELECT scholarship_payment.scholarship_payment_id, scholarship_payment.date, scholarship_payment.status, scholarship_payment.amount, scholarship_payment.memo, scholarship_payment.year, scholarship_payment.scholarship_package_scholarship_package_id, scholarship_payment.programarea_residentarea_id, scholarship_payment.programarea_payingarea_id, scholarship_payment.refund_amount, scholarship_payment.payment_request_payment_request_id, scholarship_payment.bankname, scholarship_payment.account_no, scholarship_payment.schools_school_id, scholarship_payment.group_id, scholarship_payment.status FROM " . $this->SqlFrom();
	}
   ...
   // Common render codes
		...
		if (strval($this->scholarship_package_scholarship_package_id->CurrentValue) <> "") {
			$sFilterWrk = "`status` = " . ew_AdjustSql($this->scholarship_package_scholarship_package_id->CurrentValue) . "";
	...
	function AddUserIDFilter($sFilter) {
		...
		if (!$Security->IsAdmin() && $sFilterWrk <> "") {
			$sFilterWrk = 'scholarship_payment.group_id IN (' . $sFilterWrk . ')';
			if ($sFilter <> "")
