...
class cDisburse_Payments {
	...
	function cDisburse_Payments() {
		...
		// payment_request_id
		$this->payment_request_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_payment_request_id', 'payment_request_id', 'payment_request.payment_request_id', 3, -1, FALSE, 'payment_request.payment_request_id', FALSE);
		...
		// code
		$this->code = new cField('Disburse_Payments', 'Disburse Payments', 'x_code', 'code', 'payment_request.code', 200, -1, FALSE, 'payment_request.code', FALSE);
		$this->fields['code'] =& $this->code;

		// programarea_id
		$this->programarea_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_programarea_id', 'programarea_id', 'payment_request.programarea_id', 3, -1, FALSE, 'payment_request.programarea_id', FALSE);
		$this->programarea_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['programarea_id'] =& $this->programarea_id;

		// year
		$this->year = new cField('Disburse_Payments', 'Disburse Payments', 'x_year', 'year', 'payment_request.year', 18, -1, FALSE, 'payment_request.year', FALSE);
		$this->year->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year'] =& $this->year;

		// request_date
		$this->request_date = new cField('Disburse_Payments', 'Disburse Payments', 'x_request_date', 'request_date', 'payment_request.request_date', 133, 7, FALSE, 'payment_request.request_date', FALSE);
		...
		// request_status
		$this->request_status = new cField('Disburse_Payments', 'Disburse Payments', 'x_request_status', 'request_status', 'payment_request.request_status', 202, -1, FALSE, 'payment_request.request_status', FALSE);
		$this->fields['request_status'] =& $this->request_status;

		// financial_year_financial_year_id
		$this->financial_year_financial_year_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_financial_year_financial_year_id', 'financial_year_financial_year_id', 'payment_request.financial_year_financial_year_id', 3, -1, FALSE, 'payment_request.financial_year_financial_year_id', FALSE);
		...
		// amount
		$this->amount = new cField('Disburse_Payments', 'Disburse Payments', 'x_amount', 'amount', 'payment_request.amount', 3, -1, FALSE, 'payment_request.amount', FALSE);
	...
	function SqlSelect() { // Select
		return "SELECT payment_request.payment_request_id, payment_request.year, payment_request.request_date, payment_request.programarea_id, payment_request.request_status, payment_request.code, payment_request.financial_year_financial_year_id, payment_request.amount FROM " . $this->SqlFrom();
	}

	function SqlWhere() { // Where
		$sWhere = "payment_request.request_status = 'REQUESTED'";
		$this->TableFilter = "";
		if ($this->TableFilter <> "") {
