...
//
// Table class for AllPaymentRecords
//
class cAllPaymentRecords {
	var $TableVar = 'AllPaymentRecords';
	...
	//
	function cAllPaymentRecords() {
		global $Language;

		// payment_request_id
		$this->payment_request_id = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_payment_request_id', 'payment_request_id', 'payment_request.payment_request_id', 3, -1, FALSE, 'payment_request.payment_request_id', FALSE);
		...
		// year
		$this->year = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_year', 'year', 'payment_request.year', 18, -1, FALSE, 'payment_request.year', FALSE);
		$this->year->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year'] =& $this->year;

		// request_date
		$this->request_date = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_request_date', 'request_date', 'payment_request.request_date', 133, 7, FALSE, 'payment_request.request_date', FALSE);
		...
		// programarea_id
		$this->programarea_id = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_programarea_id', 'programarea_id', 'payment_request.programarea_id', 3, -1, FALSE, 'payment_request.programarea_id', FALSE);
		$this->programarea_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['programarea_id'] =& $this->programarea_id;

		// request_status
		$this->request_status = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_request_status', 'request_status', 'payment_request.request_status', 202, -1, FALSE, 'payment_request.request_status', FALSE);
		$this->fields['request_status'] =& $this->request_status;

		// code
		$this->code = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_code', 'code', 'payment_request.code', 200, -1, FALSE, 'payment_request.code', FALSE);
		$this->fields['code'] =& $this->code;

		// financial_year_financial_year_id
		$this->financial_year_financial_year_id = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_financial_year_financial_year_id', 'financial_year_financial_year_id', 'payment_request.financial_year_financial_year_id', 3, -1, FALSE, 'payment_request.financial_year_financial_year_id', FALSE);
		...
		// amount
		$this->amount = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_amount', 'amount', 'payment_request.amount', 3, -1, FALSE, 'payment_request.amount', FALSE);
		$this->amount->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['amount'] =& $this->amount;

		// group_id
		$this->group_id = new cField('AllPaymentRecords', 'AllPaymentRecords', 'x_group_id', 'group_id', 'payment_request.group_id', 3, -1, FALSE, 'payment_request.group_id', FALSE);
	...
	function HighlightName() {
		return "AllPaymentRecords_Highlight";
	}
	...
	function SqlSelect() { // Select
		return "SELECT payment_request.payment_request_id, payment_request.year, payment_request.request_date, payment_request.programarea_id, payment_request.request_status, payment_request.code, payment_request.financial_year_financial_year_id, payment_request.amount, payment_request.group_id FROM " . $this->SqlFrom();
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "AllPaymentRecordslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("AllPaymentRecordsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "AllPaymentRecordsadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("AllPaymentRecordsedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("AllPaymentRecordsadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("AllPaymentRecordsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=AllPaymentRecords" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
