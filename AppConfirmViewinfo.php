...
//
// Table class for AppConfirmView
//
class cAppConfirmView {
	var $TableVar = 'AppConfirmView';
	...
	//
	function cAppConfirmView() {
		global $Language;

		// student_applicant_id
		$this->student_applicant_id = new cField('AppConfirmView', 'AppConfirmView', 'x_student_applicant_id', 'student_applicant_id', 'student_applicant.student_applicant_id', 3, -1, FALSE, 'student_applicant.student_applicant_id', FALSE);
		...
		// programarea_name
		$this->programarea_name = new cField('AppConfirmView', 'AppConfirmView', 'x_programarea_name', 'programarea_name', 'programarea.programarea_name', 200, -1, FALSE, 'programarea.programarea_name', FALSE);
		$this->fields['programarea_name'] =& $this->programarea_name;

		// community
		$this->community = new cField('AppConfirmView', 'AppConfirmView', 'x_community', 'community', 'community.community', 200, -1, FALSE, 'community.community', FALSE);
		$this->fields['community'] =& $this->community;

		// student_lastname
		$this->student_lastname = new cField('AppConfirmView', 'AppConfirmView', 'x_student_lastname', 'student_lastname', 'student_applicant.student_lastname', 200, -1, FALSE, 'student_applicant.student_lastname', FALSE);
		$this->fields['student_lastname'] =& $this->student_lastname;

		// student_firstname
		$this->student_firstname = new cField('AppConfirmView', 'AppConfirmView', 'x_student_firstname', 'student_firstname', 'student_applicant.student_firstname', 200, -1, FALSE, 'student_applicant.student_firstname', FALSE);
		$this->fields['student_firstname'] =& $this->student_firstname;

		// student_middlename
		$this->student_middlename = new cField('AppConfirmView', 'AppConfirmView', 'x_student_middlename', 'student_middlename', 'student_applicant.student_middlename', 200, -1, FALSE, 'student_applicant.student_middlename', FALSE);
		$this->fields['student_middlename'] =& $this->student_middlename;

		// student_gender
		$this->student_gender = new cField('AppConfirmView', 'AppConfirmView', 'x_student_gender', 'student_gender', 'student_applicant.student_gender', 200, -1, FALSE, 'student_applicant.student_gender', FALSE);
		$this->fields['student_gender'] =& $this->student_gender;

		// student_dob
		$this->student_dob = new cField('AppConfirmView', 'AppConfirmView', 'x_student_dob', 'student_dob', 'student_applicant.student_dob', 135, 7, FALSE, 'student_applicant.student_dob', FALSE);
		$this->student_dob->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['student_dob'] =& $this->student_dob;

		// AGE
		$this->AGE = new cField('AppConfirmView', 'AppConfirmView', 'x_AGE', 'AGE', 'Year(Date_Sub(CurDate(), Interval \'1995-10\' Year_Month))', 20, -1, FALSE, 'Year(Date_Sub(CurDate(), Interval \'1995-10\' Year_Month))', FALSE);
		$this->AGE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['AGE'] =& $this->AGE;

		// applicant_school_name
		$this->applicant_school_name = new cField('AppConfirmView', 'AppConfirmView', 'x_applicant_school_name', 'applicant_school_name', 'applicant_school.applicant_school_name', 200, -1, FALSE, 'applicant_school.applicant_school_name', FALSE);
		$this->fields['applicant_school_name'] =& $this->applicant_school_name;

		// app_grant_id
		$this->app_grant_id = new cField('AppConfirmView', 'AppConfirmView', 'x_app_grant_id', 'app_grant_id', 'student_applicant.app_grant_id', 3, -1, FALSE, 'student_applicant.app_grant_id', FALSE);
		$this->app_grant_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['app_grant_id'] =& $this->app_grant_id;

		// app_amount
		$this->app_amount = new cField('AppConfirmView', 'AppConfirmView', 'x_app_amount', 'app_amount', 'student_applicant.app_amount', 131, -1, FALSE, 'student_applicant.app_amount', FALSE);
		...
		$this->student_admitted_school_id = new cField('AppConfirmView', 'AppConfirmView', 'x_student_admitted_school_id', 'student_admitted_school_id', 'student_applicant.student_admitted_school_id', 3, -1, FALSE, 'student_applicant.student_admitted_school_id', FALSE);
	...
	function HighlightName() {
		return "AppConfirmView_Highlight";
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("appconfirmviewview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "appconfirmviewadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("appconfirmviewedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("appconfirmviewadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("appconfirmviewdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=AppConfirmView" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		if (!ew_Empty($this->programarea_name->CurrentValue)) {
			$this->programarea_name->HrefValue = $this->programarea_name->CurrentValue;
			if ($this->Export <> "") $AppConfirmView->programarea_name->HrefValue = ew_ConvertFullUrl($this->programarea_name->HrefValue);
		} else {
	...
	function Recordset_Selecting(&$filter) {
        ...
        $filter="student_applicant.app_grant_id!=0 and student_applicant.app_submission_year=$app_year AND student_applicant.student_resident_programarea_id=$porgramarea_id";   
	}
