...
class clogin {
	...
	function User_LoggedIn($usr) {
	    ...
	    if($_SESSION[EW_PROJECT_NAME . "_status_UserID"]==-1){
	        $_SESSION[EW_PROJECT_NAME]["PROGRAM_AREA"]=1;
	        $_SESSION[EW_PROJECT_NAME]["PROGRAM_AREA_NAME"]="B";
	    }else{
	   ...
	   // if ($GLOBALS["Security"]->CurrentUserLevelName() == "Member") $this->Page_Terminate("activitypage.php");
	//    header("location: 1landingpage.php");

	    $this->Page_Terminate("1landingpage.php");
	}                             
