...
function Row_Inserting(&$rs) {
	...
	function Row_Deleting(&$rs) {
		...
		// Enter your code here
		// To cancel, set return value to False
		if(strcasecmp($rs['request_status'],'NEWREQ')!=0){
			$this->CancelMessage="Payment record can not be deleted";
			return false;
		}
		
		if($rs['amount']!=0){
			$this->CancelMessage="Payment record can not be deleted becuase the amount is not 0.";
			return false;
		}
