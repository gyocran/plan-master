...
// Create page object
$student_applicant_student_picture_blobview = new cstudent_applicant_student_picture_blobview();
$Page =& $student_applicant_student_picture_blobview;

// Page init
$student_applicant_student_picture_blobview->Page_Init();

// Page main
$student_applicant_student_picture_blobview->Page_Main();
?>
<?php
$student_applicant_student_picture_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cstudent_applicant_student_picture_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'student_applicant_student_picture_blobview';
	...
	//
	function cstudent_applicant_student_picture_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('student_applicant');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('student_applicant', 'x_student_picture');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('student_picture'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('student_picture'));
				}
				$objBinary->Value = $rs->fields('student_picture');
